...
const Header = () => {
  ...
  return (
    ...
    >
      <nav className="container mx-auto px-4 md:px-6 lg:px-8 py-4 flex items-center justify-between">
        {/* Logo */}
        <motion.div
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="px-6 py-2 bg-white text-gray-900 border-2 border-gray-900 rounded-lg font-medium"
          >
            Register
          </motion.button>
        </div>
